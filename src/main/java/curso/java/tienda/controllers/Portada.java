...
public class Portada {
	...
	@GetMapping("/tienda")
	public String aCercaDe(Model model, @RequestParam(required=false, defaultValue="todos") String id_cat, @RequestParam(required=false, defaultValue="1") String orden) {
