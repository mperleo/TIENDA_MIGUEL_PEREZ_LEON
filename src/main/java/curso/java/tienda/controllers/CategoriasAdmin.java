...
public class CategoriasAdmin {
	...
	public String editarGuardar(Model model, @PathVariable("id_categoria") String id_cat, @ModelAttribute Categoria cat) {
	    Integer id_categoria = Integer.parseInt(id_cat);
	...
	public String borrar(Model model, @PathVariable("id_categoria") String id_cat) {
	    Integer id_categoria = Integer.parseInt(id_cat);
	    cs.del(id_categoria);
	...
	public String nuevoGuardar(Model model, @ModelAttribute Categoria cat) {
	    cs.add(cat);
