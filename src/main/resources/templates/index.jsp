    ...
    <div class="page-holder">
      ...
      <div class="container-fluid">
        ...
        <section class="pt-5">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-xl-3 col-lg-4 col-sm-6 border-category">
                <a class="category-item" href="shop.html"><img class="img-fluid" src="img/bici-city.png" alt=""><strong class="category-item-title">Bicicletas urbanas</strong></a>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 border-category">
                <a class="category-item" href="shop.html"><img class="img-fluid" src="img/bici-gravel.png" alt=""><strong class="category-item-title">Bicicletas de gravel</strong></a>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 border-category">
                <a class="category-item" href="shop.html"><img class="img-fluid" src="img/bici-mountain.png" alt=""><strong class="category-item-title">Bicicletas de montaña</strong></a>
              </div>
              <div class="col-xl-3 col-lg-4 col-sm-6 border-category">
                <a class="category-item" href="shop.html"><img class="img-fluid" src="img/bici-road.png" alt=""><strong class="category-item-title">Bicicletas de carretera</strong></a>
              </div>
            </div>
          </div>
